...
# KRAKEN
kraken2 --db /hpc/group/bio1/diego/programs/kraken2/01172023 --threads 24 --paired /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R1_paired.fq.gz         /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R2_paired.fq.gz         --output ${krakens}/${count}.kraken         --report ${k_reports}/${count}.report
...
if [ 1 -eq 1 ];
    then
        ...
        extract_kraken_reads.py -k ${krakens}/${count}.kraken                 -r ${k_reports}/${count}.report                 -s1 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R1_paired.fq.gz                 -s2 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R2_paired.fq.gz                 -o ${sequences}/${count}/unclassified_${count}_1.fq                 -o2 ${sequences}/${count}/unclassified_${count}_2.fq -t 0                 --fastq-output --include-children
    else
...
if [ 1 -eq 1 ];
    then
        ...
        extract_kraken_reads.py -k ${krakens}/${count}.kraken                 -r ${k_reports}/${count}.report                 -s1 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R1_paired.fq.gz                 -s2 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R2_paired.fq.gz                 -o ${sequences}/${count}/non_bacterial_${count}_1.fq                 -o2 ${sequences}/${count}/non_bacterial_${count}_2.fq -t 2                 --fastq-output --include-children --exclude
    else
...
if [ "Nostoc" = "-" ];
    then
        ...
        extract_kraken_reads.py -k ${krakens}/${count}.kraken                 -r ${k_reports}/${count}.report                 -s1 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R1_paired.fq.gz                 -s2 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R2_paired.fq.gz                 -o ${sequences}/${count}/Nostoc_${count}_1.fq                 -o2 ${sequences}/${count}/Nostoc_${count}_2.fq -t ${id_1_otu}                 --fastq-output --include-children
        fi
...
if [ "Lecanoromycetes" = "-" ];
    then
        ...
        extract_kraken_reads.py -k ${krakens}/${count}.kraken                 -r ${k_reports}/${count}.report                 -s1 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R1_paired.fq.gz                 -s2 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R2_paired.fq.gz                 -o ${sequences}/${count}/Lecanoromycetes_${count}_1.fq                 -o2 ${sequences}/${count}/Lecanoromycetes_${count}_2.fq -t ${id_2_otu}                 --fastq-output --include-children
fi
...
if [ "Peltigera" = "-" ];
    then
        ...
        extract_kraken_reads.py -k ${krakens}/${count}.kraken                 -r ${k_reports}/${count}.report                 -s1 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R1_paired.fq.gz                 -s2 /hpc/group/bio1/cyanolichen_holobiome/analyses/illumina/reads/${count}/${count}_R2_paired.fq.gz                 -o ${sequences}/${count}/Peltigera_${count}_1.fq                 -o2 ${sequences}/${count}/Peltigera_${count}_2.fq -t ${id_3_otu}                 --fastq-output --include-children
