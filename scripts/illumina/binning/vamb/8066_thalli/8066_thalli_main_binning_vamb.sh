...
#SBATCH --output=logs/illumina/binning/vamb/8066_thalli/8066_thalli_main_8066_thalli_binning_vamb.out # Indicate a path where a file with the output information will be created. That directory must already exist
#SBATCH --error=logs/illumina/binning/vamb/8066_thalli/8066_thalli_main_8066_thalli_binning_vamb.err # Indicate a path where a file with the error information will be created. That directory must already exist
#SBATCH --partition=common # Partition to be used to run the script
        ...
        vamb --outdir ${main_vamb} --fasta ${catalogue}/8066_thalli_catalogue.fna.gz         --bamfiles ${bam_files}/*.bam -o C --minfasta 200000
