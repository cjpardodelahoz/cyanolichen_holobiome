...
#SBATCH --output=logs/ont/qc/longqc_postrim_8026_%A_%a.out
#SBATCH --error=logs/ont/qc/longqc_postrim_8026_%A_%a.err
...
python ${longqc_path}/longQC.py sampleqc --preset ont-ligation \
  -o analyses/ont/qc/${sample}/postrim/longqc \
  -p 4 analyses/ont/reads/${sample}_trimmed.fastq