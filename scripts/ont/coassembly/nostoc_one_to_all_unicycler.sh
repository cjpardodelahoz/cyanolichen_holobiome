...
#SBATCH --output=logs/ont/coassembly/unicycler/one_to_all_long_reads/unicycler_one2one_Nostoc_%A_%a.out
#SBATCH --error=logs/ont/coassembly/unicycler/one_to_all_long_reads/unicycler_one2one_Nostoc_%A_%a.err
...
-l analyses/ont/taxonomy/sequences/concatenated/long_reads_nostoc.fasta -o analyses/ont/coassembly/one_to_all_long_reads/${count} \
--keep 2 -t 24 --mode normal \
--kmers 39,49,59,69,79,97,105,119,127