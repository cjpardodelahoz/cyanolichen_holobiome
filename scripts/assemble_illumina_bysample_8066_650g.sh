...
#SBATCH --array=7,10,24,26,27
#SBATCH --mem-per-cpu=25G  # adjust as needed
#SBATCH -c 26 # number of threads per process
#SBATCH --output=logs/illumina/assemble_illumina_bysample_8066_650g_%A_%a.out
#SBATCH --error=logs/illumina/assemble_illumina_bysample_8066_650g_%A_%a.err
...
spades.py --meta -m 650 --pe1-1 analyses/illumina/reads/${S}/${S}_R1_paired.fq.gz \
--pe1-2 analyses/illumina/reads/${S}/${S}_R2_paired.fq.gz -k 25,35,55,75,95 -t 26 \
