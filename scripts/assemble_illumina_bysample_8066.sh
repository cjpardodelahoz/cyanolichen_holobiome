...
#SBATCH --output=logs/illumina/assemble_illumina_bysample_8066_%A_%a.out
#SBATCH --error=logs/illumina/assemble_illumina_bysample_8066_%A_%a.err
...
spades.py --meta --pe1-1 analyses/illumina/reads/${S}/${S}_R1_paired.fq.gz \
